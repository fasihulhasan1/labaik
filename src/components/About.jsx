...
const About = () => {
  return (
    <div className="text-white px-40 ml-10 py-12 container animate-in zoom-in-0 duration-1000">
      <div className="max-w-screen-2xl mx-auto">
        ...
        <h2 className="text-3xl font-bold mb-2 underline hover:text-blue-700">
