    ...
    return (
        <div className="flex justify-center animate-in slide-in-from-top duration-1000">
            <form className="w-full md:w-1/2 lg:w-1/3 px-4 sm:px-8" onSubmit={handleSubmit}>
                <h1 className="text-2xl sm:text-4xl text-center text-white font-semibold mb-4">Contact Us</h1>
                ...
                <div className="mb-4">
                    <input type="text" pattern='[0-9]{3}-[0-9]{3}-[0-9]{4}' className="p-3 rounded-md w-full" value={number} onChange={e => { setNumber(e.target.value) }} placeholder="Phone Number" required />
                </div>

                <div className="mb-4">
                    <textarea name="" className="p-3 rounded-md w-full" value={disease} onChange={e => { setDisease(e.target.value) }} placeholder="Disease" id="" cols="30" rows="4" required></textarea>
                </div>

                <button type="submit" className="p-3 rounded-md w-full text-white font-semibold bg-gradient-to-r from-cyan-500 to-purple-500 mb-10">Submit</button>
            </form>
        </div>
    );
}
